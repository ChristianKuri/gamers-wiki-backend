...
describe('Editor Prompts', () => {
  ...
  describe('getEditorUserPrompt', () => {
    ...
    it('includes structural requirements', () => {
      ...
      // NOTE: title, excerpt, description, tags are now generated by Metadata Agent
      // Editor prompt only mentions categorySlug, sections, and requiredElements
      expect(prompt).toContain('categorySlug:');
      expect(prompt).toContain('sections:');
      expect(prompt).toContain('requiredElements:');
    });
  });
});
...
describe('Specialist Prompts', () => {
  ...
  describe('getSpecialistSectionUserPrompt', () => {
    ...
    it('includes article metadata', () => {
      ...
      // NOTE: title is no longer in plan (generated by Metadata Agent after Specialist runs)
      // Specialist prompt now uses game name and category instead of title
