...
describe('validateArticlePlan', () => {
  // NOTE: title, excerpt, description, and tags are now generated by the Metadata Agent
  // and are validated in validateArticleDraft, not validateArticlePlan.
  ...
  // NOTE: title-headline duplicate warning and tag validation tests removed
  // because title and tags are now generated by the Metadata Agent after the article is written.
  // These validations now happen in validateArticleDraft instead of validateArticlePlan.
...
describe('findCorruptedPlanField', () => {
  // NOTE: title, excerpt, description, and tags are now generated by the Metadata Agent
  // and are no longer part of the plan. Only sections and requiredElements are checked.
  const validPlan = {
    sections: [
