/**
 * Article Generator E2E Test - Zelda: Tears of the Kingdom
 *
 * Tests guide generation for The Legend of Zelda: Tears of the Kingdom.
 *
 * Run with: npm run test:e2e:article-guide-zelda
 */
...
const TEST_CONFIG: GameTestConfig = {
  ...
  gameSlug: 'zelda',
  instruction: 'Write a beginner guide for the first hour.',
  categorySlug: 'guides',
  expectedNameContains: 'Zelda',
};
