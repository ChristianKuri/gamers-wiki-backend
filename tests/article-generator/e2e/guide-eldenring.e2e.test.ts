/**
 * Article Generator E2E Test - Elden Ring
 *
 * Tests guide generation for Elden Ring.
 *
 * Run with: npm run test:e2e:article-guide-eldenring
 */
...
const TEST_CONFIG: GameTestConfig = {
  ...
  gameName: 'Elden Ring',
  gameSlug: 'eldenring',
  instruction: 'Write a beginner guide for new players covering the first few hours and class selection.',
  categorySlug: 'guides',
  expectedNameContains: 'Elden Ring',
};
