...
/**
 * Output from the Scout agent containing research and sources.
 */
export interface ScoutOutput {
   ...
   * Contains detailedSummary, keyFacts, dataPoints from Cleaner.
   */
  ...
  /** Combined token usage for Scout phase (same as queryPlanningTokenUsage) */
   ...
   * - 'high': Good source count and summary quality
...
export interface ScoutTokenUsage {
  ...
  /** Total Scout token usage (same as queryPlanning) */
